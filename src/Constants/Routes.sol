...
bytes4 constant ROUTE_INFINITY_POOL = bytes4(keccak256(bytes("ROUTER_INFINITY_POOL")));
bytes4 constant ROUTE_POOL_UPGRADER = bytes4(keccak256(bytes("ROUTER_POOL_UPGRADER")));
