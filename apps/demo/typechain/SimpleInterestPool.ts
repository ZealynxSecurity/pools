...
export interface SimpleInterestPoolInterface extends utils.Interface {
  functions: {
...
export interface SimpleInterestPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleInterestPoolInterface;
