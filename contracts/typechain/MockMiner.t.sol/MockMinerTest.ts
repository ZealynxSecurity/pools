...
export interface MockMinerTestInterface extends utils.Interface {
  functions: {
    ...
    "testAmountLocked()": FunctionFragment;
    "testChangeOwner()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testAmountLocked",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MockMinerTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMinerTestInterface;
  ...
  callStatic: {
    ...
    testAmountLocked(overrides?: CallOverrides): Promise<void>;

    testChangeOwner(overrides?: CallOverrides): Promise<void>;
