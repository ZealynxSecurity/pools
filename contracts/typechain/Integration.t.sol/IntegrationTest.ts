...
export interface IntegrationTestInterface extends utils.Interface {
  functions: {
    ...
    "testGlifFee()": FunctionFragment;
    "testMultiLoan()": FunctionFragment;
    "testMultiLoanRepay()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testGlifFee",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testMultiLoan",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testMultiLoanRepay",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface IntegrationTest extends BaseContract {
  ...
  callStatic: {
    ...
    testGlifFee(overrides?: CallOverrides): Promise<void>;

    testMultiLoan(overrides?: CallOverrides): Promise<void>;

    testMultiLoanRepay(overrides?: CallOverrides): Promise<void>;
