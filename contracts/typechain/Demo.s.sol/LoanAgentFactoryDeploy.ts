...
export interface LoanAgentFactoryDeployInterface extends utils.Interface {
  functions: {
...
export interface LoanAgentFactoryDeploy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LoanAgentFactoryDeployInterface;
