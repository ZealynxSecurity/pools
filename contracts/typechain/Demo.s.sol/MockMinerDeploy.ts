...
export interface MockMinerDeployInterface extends utils.Interface {
  functions: {
...
export interface MockMinerDeploy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMinerDeployInterface;
