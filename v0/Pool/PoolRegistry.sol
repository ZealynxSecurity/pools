...
import {IPoolDeployer} from "v0/Types/Interfaces/IPoolDeployer.sol";
...
contract PoolRegistry is IPoolRegistry, Ownable {
    ...
    constructor(uint256 _treasuryFeeRate, address _owner, address _router) Ownable(_owner) {
     ...
     */
    function attachPool(IPool pool) external onlyOwner {
     ...
     * @dev only the Pool Factory owner can upgrade pools
     */
    function upgradePool(IPool newPool) external onlyOwner {
