...
library AccountHelpers {
     ...
     */
    function getAccount(address router, address agent, uint256 poolID) internal view returns (Account memory) {
     ...
     * @param poolID the pool ID
     */
    function getAccount(address router, uint256 agentID, uint256 poolID) internal view returns (Account memory) {
     ...
     */
    function exists(Account memory account) internal pure returns (bool) {
     ...
     * @param poolID the pool ID
     */
    function setAccount(address router, address agent, uint256 poolID, Account memory account) internal {
     ...
     * @param poolID the pool ID
     */
    function setAccount(address router, uint256 agentID, uint256 poolID, Account memory account) internal {
     ...
     * @param poolID the pool ID
     */
    function save(Account memory account, address router, uint256 agent, uint256 poolID) internal {
